...
export default function Info() {
  return (
    <Container maxW="6xl">
      <Text fontSize={"20px"} color={"#4A2554"} fontWeight={900}>
        Ventajas de uso
      </Text>
      <Flex
        align={"center"}
      ...
      >
        <Box width={"full"}>
          ...
          <Text fontSize={"16px"} lineHeight={"25.6px"} fontWeight={400}>
            ...
            comunidad que promueve el apoyo mutuo y una seguridad digital firme.
            Elige Ututo y lidera tu camino hacia la soberanía digital con cada
            uso.
          </Text>
        </Box>
        <Flex
        ...
        >
          ...
          >
            ...
            <Text fontSize={"14px"} fontWeight={400} lineHeight={"19.6px"}>
              Apoyo y colaboración definen a nuestra comunidad. Con UTUTO, nunca
              estás solo en tu experiencia digital.
            </Text>
          </Flex>
